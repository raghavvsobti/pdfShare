...
const AnimatedGradientText = ({ children }: { children: ReactNode; }) => {
	...
	return (
		<div className={"group relative font-merriweather flex max-w-fit flex-row items-center justify-center bg-transparent pl-2 py-1.5 font-medium duration-500 ease-out [--bg-size:300%]"}>
